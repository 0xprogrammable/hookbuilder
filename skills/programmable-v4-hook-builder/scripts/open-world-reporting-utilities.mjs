...
export function installOpenWorldReportingUtilities(runtime) {
  ...
  function globalHelp() {
    return [
      ...
      "",
      "Host-neutral Submission V2 and Application V3 tooling for the protected public Applicant transport.",
      ...
      "  validate-legacy-fee-v2  Validate one explicit frozen Fee V2 replay or migration package read-only.",
      "  validate-application  Validate one current Application V3 package read-only.",
      ...
      "  application  Assemble one current Application V3 package from a complete Submission V2.",
      "  prepare-revision  Derive one exact next current Application V3 revision.",
      "  submit    Plan or confirm one protected draft Application V3 pull request.",
      "  update    Plan or confirm an immutable next revision on the same draft review thread.",
      "  status    Read Application V3 transport and review status without writing.",
      "",
