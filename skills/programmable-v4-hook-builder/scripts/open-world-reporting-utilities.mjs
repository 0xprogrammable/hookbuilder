...
export function installOpenWorldReportingUtilities(runtime) {
  ...
  function globalHelp() {
    return [
      ...
      "",
      "Host-neutral open-world v2 plus frozen legacy Application V3/Fee V2 compatibility tooling; not the public Applicant transport.",
      ...
      "  validate-application  Validate one frozen legacy Application V3 package read-only.",
      ...
      "  application  Replay one frozen legacy Application V3/Fee V2 package locally.",
      "  prepare-revision  Derive one exact next frozen legacy Application V3 revision.",
