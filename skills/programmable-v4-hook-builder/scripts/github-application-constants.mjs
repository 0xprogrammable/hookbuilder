...
export const CENTRAL_REPOSITORY = PROGRAMMABLE_REGISTRY_REPOSITORY;
export const CENTRAL_REPOSITORY_NAME = "programmable-registry";
export const CENTRAL_BASE_BRANCH = PROGRAMMABLE_REGISTRY_DEFAULT_BRANCH;
