...
export const RELEASE_TOOL_VERSIONS = Object.freeze([
  Object.freeze({ id: "node", command: Object.freeze(["node", "--version"]), policy: "node-major-at-least-20" }),
...
export function buildReleaseSpdx(kernelLocks, release) {
  ...
  for (const specification of RELEASE_KERNELS) {
    ...
    kernelPackages.push({
      ...
      downloadLocation: `https://github.com/0xprogrammable/programmable-v4-builder/tree/${release.commit}/${specification.sourcePath}`,
      filesAnalyzed: false,
      licenseConcluded: "MIT",
      licenseDeclared: "MIT",
      copyrightText: "Copyright (c) 2026 Programmable",
      ...
      externalRefs: [{
        referenceCategory: "PACKAGE-MANAGER",
        referenceType: "purl",
        referenceLocator: `pkg:github/0xprogrammable/programmable-v4-builder@${release.commit}#${specification.sourcePath}`
      }]
    });
