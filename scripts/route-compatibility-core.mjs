...
export const EXACT_SHARDS_REVIEWED_PLAN_V1 = deepFreeze({
  ...
  launchPlan: {
    priorReleaseFactoryPredeployment: {
      status: "pending-production-release-evidence",
      applicantAction: false,
      method: "pinned-create2-proxy",
      ...
      expectedFactory: "0x9442a520e7b31D10177C75A363355C2C29141ac5",
      expectedFactoryRuntimeCodeHash:
        "0x134a9e5674f22e62e939c2238693077b8027c553bb26d6a4e9e3d8554e5f85b5",
      expectedRenderer: "0x090DBD2FaB1a467f90ed82a443eFa9AAb658DE14",
      expectedRendererRuntimeCodeHash:
...
export const SUPPORTED_ROUTE_BINDINGS = Object.freeze([
  Object.freeze({
    ...
    factoryInitialStateRequirement: null,
    predeploymentEvidenceSha256: null,
    gasCapReceiptSha256: null,
...
export function assessRouteCompatibility(requestedRoute, reviewedPlan) {
  ...
  const capability = Object.freeze({
    ...
    factoryInitialStateRequirement: required.factoryInitialStateRequirement,
    predeploymentEvidenceSha256: required.predeploymentEvidenceSha256,
    gasCapReceiptSha256: required.gasCapReceiptSha256,
