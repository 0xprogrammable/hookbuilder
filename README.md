...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img alt="Release package 0.9.0" src="https://img.shields.io/badge/release-v0.9.0-F8F0E9?labelColor=010103"></a>
</p>
...
After confirming that GitHub exposes the immutable `v0.9.0` release, preview that exact Skill before installing it:
