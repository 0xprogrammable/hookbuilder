...
import { buildCentralApplicationPackage } from "../../skills/programmable-v4-hook-builder/scripts/cli-central-package.mjs";
import { materializeExample } from "../../skills/programmable-v4-hook-builder/scripts/example-materializer-core.mjs";
import { analyzeSubmission, canonicalJson } from "../../skills/programmable-v4-hook-builder/scripts/submission-core.mjs";
import { builderTemplateFromPlan } from "../../skills/programmable-v4-hook-builder/scripts/builder-template-contract.mjs";
import { composeTemplate, loadTemplateCatalog } from "../../skills/programmable-v4-hook-builder/scripts/template-catalog-core.mjs";
