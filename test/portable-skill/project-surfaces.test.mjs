...
import { requiredProjectProfiles } from "../../skills/programmable-v4-hook-builder/scripts/project-surfaces-core.mjs";
import { declaredSourceAndTestPaths } from "../../skills/programmable-v4-hook-builder/scripts/review-target-contract.mjs";
