...
import { hashV4PoolKey, keccak256Hex } from "../../skills/programmable-v4-hook-builder/scripts/evm-encoding-core.mjs";
import { createStandardV4ModeFeeBindingV1 } from "../../skills/programmable-v4-hook-builder/scripts/open-world-v2-primitives.mjs";
import { createStandardV4TradeArtifactsV1 } from "../../skills/programmable-v4-hook-builder/scripts/open-world-v2-draft-core.mjs";
import { bindQuoteDiscovery, exactForgeTestPattern, grossQuoteFromLogs, renderStandardV4TradeEvidenceRunnerV1 } from "../../skills/programmable-v4-hook-builder/scripts/template-catalog-materializer.mjs";
import {
