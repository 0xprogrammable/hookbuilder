...
import { previewFeeSplitV2 } from "../../skills/programmable-v4-hook-builder/scripts/fee-policy-v2-core.mjs";

const testDirectory = path.dirname(fileURLToPath(import.meta.url));
const vectorPath = path.resolve(
  testDirectory,
  "../../skills/programmable-v4-hook-builder/assets/reference-kernels/programmable-volume-fee-v2/test/vectors/fee-policy-v2-vectors.json"
);
