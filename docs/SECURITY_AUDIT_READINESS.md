...
| --- | --- | --- |
| Complete deterministic repository gate | The gate and clean-tree rehearsal emit commit/tree/skill-tree-bound receipts; source or generated-artifact drift invalidates prior results | Public Node 20/22 CI pending for the same frozen revision |
