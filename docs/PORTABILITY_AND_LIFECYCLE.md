...
The bundled v0.9.3 identity reports `publicationStateVerified: false`; this document alone does not prove that the tag,
release, marketplace, or installed bytes are public or live.

## Host matrix for the v0.9.3 release package
...
The v0.9.3 release package contains the versioned Codex marketplace and payload. A rollback still requires an exact previously
