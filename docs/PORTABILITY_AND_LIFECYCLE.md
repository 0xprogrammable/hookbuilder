...
## Host matrix for the stable v0.6.0 release
...
The stable v0.6.0 release contains the versioned Codex marketplace and payload. A rollback still requires an exact previously
