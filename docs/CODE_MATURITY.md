...
- Maintainability: 320 production modules, bounded size/import checks, five source-bound responsibility groups and six
  targeted mutation classes. These remain narrow proxies, not repository-wide coverage or mutation claims.
- Contract Registry: 49 portable contracts, 24 validator closures, 1,011 transitive module bindings, 172 distinct modules, and
