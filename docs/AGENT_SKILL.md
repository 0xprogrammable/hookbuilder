...
Open-world Submission V2, conditional Fee V2, layered security and public Application V3.1 are packaged for the immutable `v0.11.0`
release. The bundled status retains `publicationStateVerified: false`; this source is not proof that v0.11.0 is published
...
For reproducible public work, first verify that GitHub exposes the exact `v0.11.0` tag and release, then preview and pin
